...
def parse_training_args(parser):
    ...
    #MOT17
    parser.add_argument('--infer_data_dir', type=str, default='../DATASET/MOT17-04-FRCNN_query/images', help='Only for inference')
    ...
    parser.add_argument('--gt_txt_path', type=str, default='../DATASET/MOT17-04-FRCNN_query/gt/MOT17_004_FRCNN_gt_250.txt')
    
    parser.add_argument('--detection_weight_file', type=str, default='./weights/detection_MOT17.pt')
    parser.add_argument('--reid_weight_file', type=str, default='./weights/reid_MOT17-04_train800_pretrained.pth')
